...
public class LevelTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //Start Timer
        ...
        List<Question> questionList = dbHelper.getAllQuestions(QTtwo.TABLE_NAME2, QTtwo.COLUMN_QUESTION, QTtwo.COLUMN_OPTION1, QTtwo.COLUMN_OPTION2, QTtwo.COLUMN_OPTION3, QTtwo.COLUMN_OPTION4);
    ...
    public void levelStatus () {
        if (levelQ.PassFail()) {
            nextActivity(3, NextLevelUnlock.class);
        }
        else {
            nextActivity(2, RepeatLevel.class);
        }
    }
    ...
    public void startTimer () {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                timer.updateCountDownText(timeLeftInMillis, "#bf5fe5");
            }
